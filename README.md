...
WatchDogs is a modern, dark-themed civic actions command center and monitoring web application. The platform enables users , and features an integrated AI-driven intelligence security assistant.

## 🌟 Core Features

- **Live Dashboard:** Instantly view important stats at the top of your screen, including active emergencies, resolved issues, total police/security patrols on duty, and critical alerts.
- **Interactive Public Feed:** A community bulletin board where citizens and operators can view, post, and track local problems (like broken roads, water leaks, or safety hazards) as they happen.
